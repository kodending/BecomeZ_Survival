...
public class Battle_Normal_Attack_State : PlayerBaseState
{
    ...
    public Battle_Normal_Attack_State(PlayerController pc) : base(pc)
    {
        m_pc = pc;
    }
    ...
    {
        m_pc.m_eCurAction = PLAYERSTATE.BATTLE_NORMAL_ATTACK;
    ...
    IEnumerator ATTACKCAL()
    {
        ...
        int iDamage = AttackCal.ac.DamageCalculate(m_pc.m_sPlayerInfo.atk,
